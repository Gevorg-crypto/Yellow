...
function FormModal({setModalIsTrue, item}: { setModalIsTrue?: any, item?: any }) {
    ...
    const handlerSave = () => {
        handlerAddJog(values).then(data => console.log(data.response))
        ...
        <div className="flex flex-col justify-center rounded-xl  bg-green-800 m-8 p-7">
            ...
            <form action="" className="flex flex-col justify-center">
                <div className="pt-3">
                    ...
                    <input type="number" value={item ? item.distance : ''} onChange={(event) => {
                ...
                <div className="pt-3">
                    ...
                    <input type="number" value={item ? item.time : ''} onChange={(event) => {
                ...
                <div className="pt-3">
                    ...
                    <input type="date" value={item ? item.date : ''} onChange={(event) => {
            ...
            <div className="flex justify-center mt-5">
                <button onClick={() => handlerSave()}
                        className="py-2 w-full rounded-full border-2  border-white text-white">Save
                </button>
            </div>
        </div>
    );
